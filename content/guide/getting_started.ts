...
To use ProbeJS, you first need to start up your game with both it and KubeJS installed, go into a world, and run the command <Cmd>/probejs dump</Cmd>.

This command will generate all the typings (documentation) within your modpack's folder.

The next thing you need to do is open your modpack's folder (be it named .minecraft, or your modpack's name) in Visual Studio Code and open the <Folder>/kubejs</Folder> folder.

## The Folder Structure

The [Folder Structure](/docs/folder_structure) category explains the kubejs folder structure in more depth.
