...
public "load"(): void
public "handler$zzd000$loadJavaClass"(name0: string, warn: boolean, cir: $CallbackInfoReturnable$Type<(any)>): void
...
(title: $Component$Type, rows: integer, gui: $Consumer$Type<($ChestMenuData$Type)>): void
}
...
(arg0: $RecipeJS$Type, arg1: $RecipeSchemaType$Type, arg2: ($RecipeKey$Type<(any)>)[], arg3: $ComponentValueMap$Type): void
}
...
(channel: string, data: $CompoundTag$Type): void
}
