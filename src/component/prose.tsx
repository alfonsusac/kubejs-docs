...
export const prose = {
  ...
  ul: (props: ComponentProps<"ul">) =>
    <ul {...props} className={cn("list-disc pl-6 my-4 mb-8 in-[li]:my-3 in-[li]:pl-3", props.className)} />,
  ol: (props: ComponentProps<"ol">) =>
    <ol {...props} className={cn("list-decimal pl-6 my-4 mb-8 in-[li]:my-3 in-[li]:pl-3", props.className)} />,
  li: (props: ComponentProps<"li">) =>
    <li {...props} className={cn("mb-2 pl-2 text-foreground/80", props.className)} />,
